    ...
    tabs: [
      {
        ...
        rowActions: [
          { key: 'sort', label: '分拣', transition: 'sort', visible: ['PENDING', 'PARTIAL'], message: '确定分拣该商品吗？' },
          { key: 'markShortage', label: '标记缺货', transition: 'markShortage', visible: ['PENDING', 'PARTIAL'], message: '确定标记该商品为缺货？' },
          { key: 'cancelShortage', label: '取消缺货', transition: 'cancelShortage', visible: ['SHORTAGE'], message: '确定要取消该商品缺货状态吗？' },
      ...
      },
      {
        ...
        toolbar: [
          { key: 'batchSort', label: '一键分拣', primary: true, batchTransition: 'sort', message: '确定一键分拣选中客户的商品吗？', visibleStatuses: ['PENDING', ''] },
