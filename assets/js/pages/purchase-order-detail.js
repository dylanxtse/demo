(function () {
  ...
  var schoolDateAnnotation = {
    id: 'purchase-order-detail-school-expected-date',
    target: 'custom',
    targetSelector: '.purchase-order-basic-info',
    placement: 'right',
    title: '学校期望送达时间',
    items: ['采购单详情区分展示学校期望送达时间和企业期望送达时间。']
  };
  var enterpriseDateAnnotation = {
    id: 'purchase-order-detail-enterprise-expected-date',
    target: 'custom',
    targetSelector: '.purchase-order-basic-info',
    placement: 'right',
    title: '企业期望送达时间',
    items: ['企业期望送达时间来自采购任务生成采购单时的提交值。']
  };
    ...
    '<section class="page-card purchase-page purchase-detail-page purchase-order-detail-page" aria-label="采购单详情">',
      ...
      '<div class="purchase-order-detail-scroll">',
        '<section class="purchase-order-detail-section purchase-order-basic-info">',
          renderAnnotationMarker(schoolDateAnnotation),
          renderAnnotationMarker(enterpriseDateAnnotation, 'enterprise', true),
