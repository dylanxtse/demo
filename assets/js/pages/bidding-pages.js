    ...
    const form = `
      <div class="page-card bidding-form-page" id="bidFormPage">
        ...
        <div class="bidding-form-grid">
          ...
          <div class="bidding-form-field"><label for="winnerLimit">供应商允许中标数量</label><div class="bidding-control-stack"><input id="winnerLimit" data-field="winnerLimit" type="number" min="0" placeholder="请输入" value="${inputValue(existing?.winnerLimit ?? 1)}"></div></div>
