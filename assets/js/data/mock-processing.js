  ...
  window.MockProcessingOrders = [
    {
      ...
      outputs: [
        { productCode: 'SP0300039', productName: '土豆丝', unit: '斤', refCoefficient: 1.2, refQty: 60, actualQty: 58, costPrice: '' },
        { productCode: 'SP0300014', productName: '苹果', unit: '斤', refCoefficient: 0.8, refQty: 40, actualQty: 39, costPrice: '' }
      ],
    ...
    },
    {
      ...
      outputs: [
        { productCode: 'SP0300015', productName: '香蕉', unit: '斤', refCoefficient: 1.0, refQty: 20, actualQty: '', costPrice: '' }
      ],
    ...
    },
    {
      ...
      outputs: [
        { productCode: 'SP0300031', productName: '鲫鱼', unit: 'L', refCoefficient: 1.0, refQty: 10, actualQty: 0, costPrice: '' }
      ],
    ...
    },
    {
      ...
      outputs: [
        { productCode: 'SP0300039', productName: '土豆丝', unit: '斤', refCoefficient: 1.5, refQty: 22.5, actualQty: 22, costPrice: '' },
        { productCode: 'SP0300020', productName: '西红柿', unit: 'KG', refCoefficient: 0.9, refQty: 13.5, actualQty: 13, costPrice: '' }
      ],
